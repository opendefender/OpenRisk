...
const fr = {
  ...
  g_reduce: 'Maîtriser les risques', g_monitor: 'Piloter la posture', g_estate: 'Cartographier le patrimoine',
  g_threats: 'Anticiper les menaces', g_prove: 'Prouver la conformité', g_decide: 'Décider & rapporter',
...
const en: typeof fr = {
  ...
  g_reduce: 'Reduce risk', g_monitor: 'Monitor posture', g_estate: 'Map your estate',
  g_threats: 'Anticipate threats', g_prove: 'Prove compliance', g_decide: 'Decide & report',
  g_admin: 'Administration',
