...
const fr = {
  ...
  n_reports: 'Rapports', n_ai: 'IA Advisor', n_emerging: 'Risques émergents', n_settings: 'Paramètres', n_superadmin: 'Super Admin',
...
const en: typeof fr = {
  ...
  n_reports: 'Reports', n_ai: 'AI Advisor', n_emerging: 'Emerging risks', n_settings: 'Settings', n_superadmin: 'Super Admin',
