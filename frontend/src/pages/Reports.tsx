    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-surface border border-border rounded-lg p-4">
          <div className="text-fg-secondary text-sm mb-2">Total Reports</div>
      ...
      <div className="bg-surface border border-border rounded-lg overflow-hidden">
        <div className="grid grid-cols-12 gap-4 px-6 py-3 text-xs text-fg-secondary border-b border-border font-semibold">
              ...
              >
                <div className="col-span-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-medium text-fg-primary truncate">{report.title}</p>
                      <p className="text-xs text-fg-muted">{report.format}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-span-2">
                  <p className="text-sm text-fg-secondary">{report.generated_by}</p>
                </div>
                <div className="col-span-2">
      ...
      <div className="mt-6 bg-surface border border-border rounded-lg p-6">
        ...
        <p className="text-fg-secondary mb-4">Configure automatic report generation</p>
