          ...
          >
            <div className="bg-surface border border-border rounded-xl shadow-xl overflow-hidden">
              ...
              <div className="bg-linear-to-r from-primary/20 to-primary/10 border-b border-border px-6 py-4 flex items-center justify-between">
                <h2 className="text-xl font-bold text-fg-primary">Create New User</h2>
                <button
                  onClick={onClose}
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
                ...
                <div>
                  <label className="text-sm font-medium text-fg-primary block mb-2">Email *</label>
                  <Input
                    type="email"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-sm font-medium text-fg-primary block mb-2">Role *</label>
                    <select
                      value={formData.role}
                      onChange={(e) => handleChange('role', e.target.value)}
                      disabled={isLoading}
                      className="w-full bg-surface-1 border border-border rounded-lg px-3 py-2 text-sm text-fg-primary focus:ring-2 focus:ring-primary/50 outline-none"
                    >
                  ...
                  <div>
                    <label className="text-sm font-medium text-fg-primary block mb-2">Group</label>
                    <Input
