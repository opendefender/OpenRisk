...
export const NotificationPreferences: React.FC<NotificationPreferencesProps> = ({
  ...
  if (!preferences) return <div className="preferences-error">Failed to load preferences</div>;
    ...
    <div className="notification-preferences">
      ...
      <div className="preferences-content">
          ...
          <div className="preference-item">
            <label>
              <input
                ...
                onChange={() => handleToggle('enable_desktop_notifications')}
              />
        ...
        <section className="preferences-section">
          ...
          <div className="preference-item">
            <label>
              <input
                ...
                onChange={() => handleToggle('email_on_mitigation_deadline')}
              />
              ...
              <div className="sub-setting">
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleNumberChange('email_deadline_advance_days', parseInt(e.target.value))
                    }
                  />
                </label>
              </div>
          ...
          <button className="test-button" onClick={() => handleTestNotification('email')}>
            Send Test Email
          </button>
        </section>
              ...
              <div className="preference-item">
                <label>
                  <input
                    ...
                    onChange={() => handleToggle('slack_on_mitigation_deadline')}
                  />
                  <span>Mitigation Deadline</span>
                </label>
              </div>
              ...
              <div className="preference-item">
                <label>
                  <input
                    ...
                    onChange={() => handleToggle('slack_on_action_assigned')}
                  />
                  <span>Action Assigned</span>
                </label>
              </div>

              <button className="test-button" onClick={() => handleTestNotification('slack')}>
              ...
              <div className="preference-item">
                <label>
                  <input
                    ...
                    onChange={() => handleToggle('webhook_on_mitigation_deadline')}
                  />
                  <span>Mitigation Deadline</span>
                </label>
              </div>
              ...
              <div className="preference-item">
                <label>
                  <input
                    ...
                    onChange={() => handleToggle('webhook_on_action_assigned')}
                  />
                  <span>Action Assigned</span>
                </label>
              </div>

              <button className="test-button" onClick={() => handleTestNotification('webhook')}>
                Send Test Webhook
              </button>
            </>
          )}
