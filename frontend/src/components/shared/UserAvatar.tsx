...
export const UserAvatar = ({
  ...
  return (
    <div className="group relative">
      {avatarContent}
      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-surface-1 border border-border-default rounded text-xs text-fg-secondary whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
        {name}
      </div>
    </div>
  );
