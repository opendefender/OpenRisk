...
type BulkOperation struct {
	...
	OperationType BulkOperationType   gorm:"type:varchar();not null" json:"operation_type"
	Status        BulkOperationStatus gorm:"type:varchar();default:'pending'" json:"status"
