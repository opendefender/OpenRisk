...
type TrendHandler struct {
	trendService *service.TrendAnalysisService
}

// NewTrendHandler creates a new trend handler
func NewTrendHandler(trendService *service.TrendAnalysisService) *TrendHandler {
	return &TrendHandler{
...
func (h *TrendHandler) GetRecommendations(c *fiber.Ctx) error {
	...
	var forecast *domain.TrendForecast
...
func (h *TrendHandler) GetAnomalies(c *fiber.Ctx) error {
	...
	var anomalies []domain.TrendAnalysis
