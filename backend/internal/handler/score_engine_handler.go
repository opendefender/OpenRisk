...
type ScoreEngineHandler struct {
	db      *gorm.DB
	service *service.ScoreEngineService
}

// NewScoreEngineHandler crée un nouvel handler pour le Score Engine
func NewScoreEngineHandler(db *gorm.DB, service *service.ScoreEngineService) *ScoreEngineHandler {
...
// @Accept json
// @Produce json
// @Success 200 {array} service.ScoringConfig
...
// @Success 200 {object} service.ScoringConfig
...
// @Success 201 {object} service.ScoringConfig
...
func RegisterScoreEngineRoutes(app *fiber.App, db *gorm.DB, service *service.ScoreEngineService) {
