...
type EnhancedDashboardHandler struct {
	dashboardDataService *service.DashboardDataService
}

// NewEnhancedDashboardHandler creates a new enhanced dashboard handler
func NewEnhancedDashboardHandler(dashboardDataService *service.DashboardDataService) *EnhancedDashboardHandler {
